...
Python does not support formal access control, but names beginning with single underscore are conventionally akin to protected, while names begining with a double underscore (other than special methods) are akin to private.